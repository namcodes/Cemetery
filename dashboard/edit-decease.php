      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row ml-2 mb-2">
            <div class="col-lg-10">
              <?php
              if (isset($_GET['record_id']) && isset($_GET['token'])) {
                $record_id = $_GET['record_id'];
                $record_query = $conn->query("SELECT r.date_transfer as transfer_date, r.record_id as record_id, r.fullname as fullname, r.grave_section as grave_section, r.born as born, r.died as died, r.burial as burial, b.name as name, b.contact as contact, b.email_address as email FROM tbl_records r LEFT JOIN tbl_billings b ON r.billing_id = b.billing_id WHERE r.record_id = '{$record_id}' LIMIT 1");
                if ($record_query->num_rows > 0) {
                  $tbl_record = $record_query->fetch_assoc();
                } else {
                  $tbl_record = "Unknown Data";
                }
              } else {
              ...
              <form action="actions/records.php" method="post">
                <div class="card card-outline card-primary">
                    ...
                    <div class="row">
                      <section class="col-lg-6">
                        ...
                        <div class="form-group">
                          ...
                          <input id="fullname" type="text" name="fname" value="<?= $tbl_record['fullname'] ?>" class="form-control" placeholder="Full Name">
                        </div>
                        <div class="form-group">
                          <label for="born">Born</label>
                          <input type="date" name="born" value="<?= $tbl_record['born'] ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                          <label for="died">Died</label>
                          <input type="date" value="<?= $tbl_record['died'] ?>" name="died" class="form-control" required>
                        </div>
                        <div class="form-group">
                          <label for="burial">Burial</label>
                          <input type="date" name="burial" value="<?= $tbl_record['burial'] ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                          <label for="package">Niche</label>
                          <select name="package" class="form-control btn-packages">
                        ...
                        <div class="form-group">
                          <label for="transfer_date" class="badge badge-warning text-white">Transfer Date</label>
                          <input type="date" name="transfer_date" value="<?= $tbl_record['transfer_date'] ?>" class="form-control" required>
                        </div>
                      </section>
                      <section class="col-lg-6">
                        <div class="card-header mb-4">
                        ...
                        <div class="form-group">
                          ...
                          <input id="contact_name" type="text" name="bname" class="form-control" value="<?= $tbl_record['name'] ?>" placeholder="Full Name" required>
                        </div>
                        <div class="form-group">
                          <label for="contact">Phone Number</label>
                          <input id="contact" type="text" name="contact" class="form-control contact" maxlength="11" value="<?= $tbl_record['contact'] ?>" placeholder="Phone Number">
                        ...
                        <div class="form-group">
                          ...
                          <input id="email" type="text" name="email" class="form-control" value="<?= $tbl_record['email'] ?>" placeholder="Email Address">
                          <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                          ...
                          <input id="unitprice" type="text" name="unitprice" class="form-control readonly" placeholder="Select Niche..." readonly>
                        </div>
                        <div class="form-group">
                          <label for="grave_section">Grave no. & Section</label>
                          <select name="grave_section" class="form-control">
                  ...
                  <div class="card-footer">
                    <button id="btn-submit" type="submit" name="edit-records" class="btn btn-primary">Submit</button>
                  </div>
                </div>
              </form>
            </div>
